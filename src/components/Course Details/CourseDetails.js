...
const CourseDetails = (props) => {
    ...
    const offBtn = props.showEnrollBtn
        ...
        <div className="row details-box">
            ...
            <div className="col-md-7">
                <div className="details-content text-right">
                    ...
                    {
                        offBtn && <button onClick={() => props.addToCartHandler(props.course)} className="btn btn-success">Enroll Now <FontAwesomeIcon icon={faCartPlus} /></button>
                    }
                </div>
            </div>
        </div >
